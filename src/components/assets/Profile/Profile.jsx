...
const SaveIcon = (props) => (<svg {...props} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>);
    ...
    const handleSaveSection = (e) => {
        ...
        if (isEditMode) {
            ...
            const newSection = {
                id: newId,
                name: formName,
                subtitle: formDesc || 'New Class Section',
                students: 0,
            ...
            <div className="pro-identity-card">
                <div className="pro-id-left">
                    <div className="pro-avatar-wrapper">
                        <img src={profileData.photoURL || fallbackAvatar} alt="Profile" className="pro-avatar" onError={(e) => { e.target.onerror = null; e.target.src = fallbackAvatar; }} />
                ...
                <div className="pro-id-right">
                    <div className="pro-stat-item"><div className="pro-stat-icon-box" style={{background: '#DCFCE7', color: '#166534'}}><FileTextIcon /></div><div><span className="pro-stat-val">{reportsCount}</span><span className="pro-stat-lbl">Reports</span></div></div>
                    <div className="pro-stat-item"><div className="pro-stat-icon-box" style={{background: '#DBEAFE', color: '#1E40AF'}}><UsersIcon /></div><div><span className="pro-stat-val">{activeSections}</span><span className="pro-stat-lbl">Sections</span></div></div>
                    <div className="pro-stat-item"><div className="pro-stat-icon-box" style={{background: '#FEF3C7', color: '#B45309'}}><TrophyIcon /></div><div><span className="pro-stat-val">{totalUsers}</span><span className="pro-stat-lbl">Users</span></div></div>
                </div>
            </div>

            {/* Personal Info Card */}
            <div className="pro-settings-card">
                <div className="pro-card-header"><h3>Personal Information</h3><p>Update your photo and personal details here.</p></div>
                <form className="pro-form" onSubmit={(e) => { e.preventDefault(); alert("Update coming soon!"); }}>
                    <div className="pro-form-grid">
                        <div className="pro-form-group"><label>Full Name</label><input type="text" value={name} onChange={(e) => setName(e.target.value)} /></div>
                        <div className="pro-form-group"><label>Email Address</label><input type="email" value={email} onChange={(e) => setEmail(e.target.value)} /></div>
                        <div className="pro-form-group"><label>Role (Read Only)</label><input type="text" value={role} disabled className="pro-input-disabled" /></div>
                        <div className="pro-form-group"><label>System ID (Read Only)</label><input type="text" value={id} disabled className="pro-input-disabled" /></div>
                    </div>
                    <div className="pro-form-actions"><button type="button" className="pro-btn-cancel">Cancel</button><button type="submit" className="pro-btn-save">Save Changes</button></div>
                </form>
            </div>
                    ...
                    <div className="pro-modal-card">
                        ...
                        <form onSubmit={handleSaveSection}>
                            <div className="pro-form-group" style={{ marginBottom: '1rem' }}>
                                ...
                                <input type="text" placeholder="e.g. BSIT 3D" value={formName} onChange={(e) => setFormName(e.target.value)} autoFocus required />
                            </div>
                            <div className="pro-form-group" style={{ marginBottom: '1rem' }}>
